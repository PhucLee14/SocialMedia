        ...
        >
          ...
          >
            ...
            >
              ...
              {image.length > 1 && currentImageIndex < image.length - 1 && (
                <Box
                  sx={{
                    position: "absolute",
                    top: "50%",
                  ...
                  <button
                    onClick={() =>
                      setCurrentImageIndex((prev) =>
                        prev < image.length - 1 ? prev + 1 : prev,
                      )
                    }
                    style={{
                      background: "#fff",
            ...
            >
              ...
              >
                <p style={{ color: "#999" }}>Add collaborators</p>
              ...
              >
                <Box
                  ...
                  onClick={() => setIsAccessibility(!isAccessibility)}
                >
                  <p>Accessibility</p>
                  {isAccessibility ? (
                ...
                <Box
                  sx={{
                    display: isAccessibility ? "flex" : "none",
                    flexDirection: "column",
                    alignItems: "start",
                    gap: 1,
                  }}
                >
                  ...
                  <Box sx={{ width: "100%" }}>
                    <TextField outline="none" sx={{ width: "100%" }} />
                  </Box>
                </Box>
              </Box>
              <Box
              ...
              >
                ...
                <Box
                  sx={{
                    display: isAdvancedSettings ? "block" : "none",
                  }}
                >
                  <Box
                    sx={{
                      ...
                      <Switch
                        onChange={(e) => {
                          dispatch({
                            ...
                            payload: !state.hideLikeAndComment,
                          });
                        }}
                      />
                    </Box>
