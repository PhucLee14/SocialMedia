...
function PostDetailModal({ post, onClick }) {
  ...
  const handleSendComment = async (e) => {
    ...
    try {
      ...
      setCommentList(Array.isArray(updatedComments) ? updatedComments : []);
    } catch (error) {
      console.log(error);
    }
  };
        ...
        >
          <Box
            sx={{
              ...
              transform: `translateX(-${currentMediaIndex * 770}px)`,
            }}
          >
                ...
                <button
                  onClick={() =>
                    setCurrentMediaIndex((prev) =>
                      prev < post.medias.length - 1 ? prev + 1 : prev,
                    )
                  }
                  style={{
                    background: "#fff",
            ...
            >
              ...
              <Box>
                ...
                >
                  ...
                  <Time time={post.createdAt} isShort={false} />
                </Box>
                <Box
                  sx={{
                    display: "flex",
